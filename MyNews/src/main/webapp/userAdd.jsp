		...
		<div class="sidebar">
			...
			<div class="side_list">
				<ul>
						...
						<li><a href='detail?nid=${news.nid}'><b>修改用户</b></a></li>
		...
		<div class="main">
			...
			<div class="content">
				...
				<form action="doAddUser" method="post">
					用户名<input type="password" name="newname" id="newname"
					value="" class="login_input" />
					<br />
					密码<input type="password" name="newupwd" id="newupwd"
					value="" class="login_input" />
					<input type="submit"
					class="login_sub" value="添加" />
				</form>
				</ul>
				<ul class="classlist">
