...
<body>
	<div id="header">
		<div id="top_login">
			<form action="op=login" method="post" onsubmit="return check()">
		...
		<div class="sidebar">
			...
			<div class="side_list">
				<ul>
						...
						<li><a href='addUser'><b>添加用户</b></a></li>
						<li><a href='updateUser'><b>修改用户</b></a></li>
						<li><a href='deleteUser'><b>删除用户</b></a></li>
				</ul>
			</div>
